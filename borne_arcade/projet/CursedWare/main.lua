--- @file main.lua
--- @warning L'éxecution de Love2D à une importance pour la sauvegarde des highscores. Si le cd de la console ne point pas vers le fichier du jeu. Le jeu crashera à la sauvegarde.
